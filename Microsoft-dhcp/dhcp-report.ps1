...
write-host $A
# FREE ip in DOMAIN
Invoke-Command -ComputerName "domain01" -Credential $creds -ScriptBlock { Get-DhcpServerv4Scope | select ScopeID | ForEach-Object { Get-DhcpServerv4FreeIPAddress -ScopeId $_.ScopeId -NumAddress 1024 }}
